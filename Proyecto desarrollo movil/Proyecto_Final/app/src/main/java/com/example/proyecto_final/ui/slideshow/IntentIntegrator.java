...
public class IntentIntegrator {
    ...
    private final estudianteAsisqr activity;
    ...
    public IntentIntegrator(estudianteAsisqr activity) {
    ...
    private AlertDialog showDownloadDialog() {
        AlertDialog.Builder downloadDialog = new AlertDialog.Builder(activity.getContext());
